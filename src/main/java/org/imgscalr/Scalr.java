...
public class Scalr {
     ...
     */
    private static final String DEBUG_PROPERTY_NAME = "imgscalr.debug";
     ...
     */
    private static final String LOG_PREFIX_PROPERTY_NAME = "imgscalr.logPrefix";
     ...
     */
    private static final boolean DEBUG = Boolean.getBoolean(DEBUG_PROPERTY_NAME);
     ...
     */
    private static final String LOG_PREFIX = System.getProperty(
     ...
     *                                  operations.
     */
    private static BufferedImage apply(BufferedImage src, BufferedImageOp... ops)
        ...
        for (BufferedImageOp bufferedImageOp : ops) {
            ...
            if (DEBUG)
                log(1, "Applying BufferedImageOp [class=%s, toString=%s]...",
                        bufferedImageOp.getClass(), bufferedImageOp.toString());
            ...
            BufferedImage result = bufferedImageOp.filter(src, dest);
    ...
    public static BufferedImage crop(BufferedImage src, int width, int height,
            ...
            ImagingOpException {
        return crop(src, 0, width, height, ops);
    }
     ...
     *                                  operations.
     */
    private static BufferedImage crop(BufferedImage src, int y,
        ...
        if (y < 0 || width < 0 || height < 0)
            throw new IllegalArgumentException("Invalid crop bounds: x [" + 0
        ...
        if ((width) > srcWidth)
            throw new IllegalArgumentException(
                    "Invalid crop bounds: x + width [" + (width)
        ...
        if (DEBUG)
            log(0,
                    ...
                    srcWidth, srcHeight, 0, y, width, height);
         ...
         * region).
         */
        g.drawImage(src, 0, 0, width, height, 0, y, (width), (y + height),
                null);
        g.dispose();
     ...
     *                                  operations.
     */
    private static BufferedImage pad(BufferedImage src, int padding,
     ...
     * @see Mode
     */
    private static BufferedImage resize(BufferedImage src, Method scalingMethod,
     ...
     */
    private static void log(int depth, String message, Object... params) {
        if (Scalr.DEBUG) {
    ...
    private static BufferedImage scaleImageIncrementally(BufferedImage src,
        ...
        do {
            ...
            BufferedImage incrementalImage = scaleImage(src, currentWidth,
                    currentHeight, RenderingHints.VALUE_INTERPOLATION_BICUBIC);
