...
public class KDTree<T> {
     ...
     */
    public T nearest(double [] key) throws KeySizeException, CloneNotSupportedException {
    ...
    public List<T> nearest(double [] key, int n)
            throws KeySizeException, IllegalArgumentException, CloneNotSupportedException {
    ...
    public List<T> nearestEuclidean(double [] key, double dist)
            throws KeySizeException, CloneNotSupportedException {
    ...
    private NearestNeighborList<KDNode<T>> getnbrs(double [] key, int n,
                                                   Checker<T> checker) throws KeySizeException, CloneNotSupportedException {
    ...
    private  List<T> nearestDistance(double [] key, double dist,
                                     DistanceMetric metric) throws KeySizeException, CloneNotSupportedException {
