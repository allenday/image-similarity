...
class HRect {
    ...
    private HRect(HPoint vmin, HPoint vmax) throws CloneNotSupportedException {
    ...
    static HRect infiniteHRect(int d) throws CloneNotSupportedException {
    ...
    // currently unused
    protected HRect intersection(HRect r) throws CloneNotSupportedException {
